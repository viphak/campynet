...
namespace Campy.TreeWalker
{
    ...
    public class CSharpOutputVisitor : IAstVisitor
    {
        ...
        public void WriteCommaSeparatedListInParenthesis(IEnumerable<AstNode> list, bool spaceWithin)
        {
            LPar();
            if (list.Any())
            {
        ...
        public virtual void WriteMethodBody(BlockStatement body)
        {
            if (body.IsNull)
            {
                Semicolon();
        ...
        public static string PrintPrimitiveValue(object val)
        {
            ...
            CSharpFormattingOptions o = default(CSharpFormattingOptions);
            CSharpOutputVisitor visitor = new CSharpOutputVisitor(writer, o);
