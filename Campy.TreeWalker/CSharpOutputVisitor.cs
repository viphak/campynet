...
//    {
//        protected readonly IOutputFormatter formatter; // KED -- add protected.
//        public readonly CSharpFormattingOptions policy;  // KED -- add public.
//        protected readonly Stack<AstNode> containerStack = new Stack<AstNode>();  // KED -- add protected.
//        protected readonly Stack<AstNode> positionStack = new Stack<AstNode>(); // KED -- add protected.

//        /// <summary>
//        /// Used to insert the minimal amount of spaces so that the lexer recognizes the tokens that were written.
//        /// </summary>
//        protected LastWritten lastWritten; // KED -- add protected.

//        protected enum LastWritten // KED -- add protected.
//        {
//            Whitespace,
//            Other,
//            KeywordOrIdentifier,
...
//        public CSharpOutputVisitor(TextTokenWriter textWriter, CSharpFormattingOptions formattingPolicy)
//        {
//            if (textWriter == null) {
...
//        public void StartNode(AstNode node)  // KED -- add public
//        {
...
//        public void EndNode(AstNode node)// KED -- add public
//        {
...
//        /// </summary>
//        public void WriteSpecialsUpToRole(Role role)// KED -- add public
//        {
//            WriteSpecialsUpToRole(role, null);
//        }

//        public void WriteSpecialsUpToRole(Role role, AstNode nextNode) // KED -- add public
//        {
//            if (positionStack.Count == 0) {
//                return;
//            }
...
//        public virtual void Comma(AstNode nextNode, bool noSpaceAfterComma = false) // KED -- add public virtual
//        {
...
//        /// </summary>
//        public virtual void OptionalComma()// KED -- add public virtual
//        {
...
//        /// </summary>
//        public virtual void OptionalSemicolon() // KED -- add public virtual
//        {
...
//        public virtual void WriteCommaSeparatedList(IEnumerable<AstNode> list) // KED -- add public virtual
//        {
//            bool isFirst = true;
...
//        public void WriteCommaSeparatedListInParenthesis(IEnumerable<AstNode> list, bool spaceWithin)// KED -- add public
//        {
//            LPar();
//            if (list.Any()) {
//                Space(spaceWithin);
...
//        /// </summary>
//        public virtual void WriteKeyword(TokenRole tokenRole)// KED -- add public virtual
//        {
//            WriteKeyword(tokenRole.Token, tokenRole);
//        }

//        public virtual void WriteKeyword(string token, Role tokenRole = null)// KED -- add public virtual
//        {
//            if (tokenRole != null) {
...
//        public virtual void WriteIdentifier(string identifier, Role<Identifier> identifierRole = null)// KED -- add public virtual
//        {
...
//        public virtual void WriteToken(TokenRole tokenRole)// KED -- add public virtual
//        {
//            WriteToken(tokenRole.Token, tokenRole);
//        }

//        public virtual void WriteToken(string token, Role tokenRole)// KED -- add public virtual
//        {
//            WriteSpecialsUpToRole(tokenRole);
...
//        public virtual void LPar()// KED -- add public virtual
//        {
//            WriteToken(Roles.LPar);
//        }

//        public virtual void RPar()// KED -- add public virtual
//        {
...
//        /// </summary>
//        public virtual void Semicolon()// KED -- add public virtual
//        {
...
//        /// </summary>
//        public virtual void Space(bool addSpace = true)// KED -- add public virtual
//        {
//            if (addSpace) {
//                formatter.Space();
...
//        public virtual void NewLine()// KED -- add public virtual
//        {
//            formatter.NewLine();
//            lastWritten = LastWritten.Whitespace;
//        }

//        public virtual void OpenBrace(BraceStyle style)// KED -- add public virtual
//        {
...
//        public virtual void CloseBrace(BraceStyle style)// KED -- add public virtual
//        {
...
//                WriteToken("^", Roles.Identifier); // KED
//            }
//        }
...
//        public virtual void WriteModifiers(IEnumerable<CSharpModifierToken> modifierTokens)// KED -- add public virtual
//        {
...
//        public virtual void WriteMethodBody(BlockStatement body)// KED -- add public virtual
//        {
//            if (body.IsNull) {
//                Semicolon();
//            } else {
...
//        public virtual void WriteAttributes(IEnumerable<AttributeSection> attributes)// KED -- add public virtual
//        {
...
//        public virtual void WritePrivateImplementationType(AstType privateImplementationType)// KED -- add public virtual
//        {
