...
namespace Graphs
{
    public class TreeAdjList<NAME, NODE, EDGE> : GraphAdjList<NAME, NODE, EDGE>
        ...
        where EDGE : TreeAdjList<NAME, NODE, EDGE>.Edge, new()
    {
        ...
        new public class Vertex : GraphAdjList<NAME, NODE, EDGE>.Vertex
        {
            public Vertex()
                : base()
            {
        ...
        new public class Edge : GraphAdjList<NAME, NODE, EDGE>.Edge
        {
            public Edge()
                : base()
            {
    ...
    public class TreeAdjListVertex<NAME>
        : TreeAdjList<NAME, TreeAdjListVertex<NAME>, TreeAdjListEdge<NAME>>.Vertex
    {
    }

    public class TreeAdjListEdge<NAME>
        : TreeAdjList<NAME, TreeAdjListVertex<NAME>, TreeAdjListEdge<NAME>>.Edge
    {
    }

    public class TreeAdjList<NAME>
        : TreeAdjList<NAME,
            TreeAdjListVertex<NAME>,
            TreeAdjListEdge<NAME>>
    {
    }
}
