...
namespace Graphs
{
    ...
    {
        protected FiniteTotalOrderSet<NAME> NameSpace = new FiniteTotalOrderSet<NAME>();
        protected NODE[] VertexSpace = new NODE[10];
        protected bool[] VertexSpaceDefined = new bool[10];
        protected EDGE[] EdgeSpace = new EDGE[10];
