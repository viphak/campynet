...
{
    public class MethodParameters_CAMPY_AstBuilder : CAMPY_AstBuilder
    {
        public MethodParameters_CAMPY_AstBuilder(DecompilerContext context)
            : base(context)
        { }
        ...
        public override void GenerateCode(ITextOutput output)
        {
            ...
            syntaxTree.AcceptVisitor(new MethodParameters_CSharpOutputVisitor(outputFormatter, formattingPolicy));
        }
    }
    ...
    /// Outputs the AST.
    /// </summary>
    public class MethodParameters_CSharpOutputVisitor : CSharpOutputVisitor
    {
        public MethodParameters_CSharpOutputVisitor(IOutputFormatter formatter, CSharpFormattingOptions formattingPolicy)
