...
{
    public class MethodBody_CAMPY_AstBuilder : CAMPY_AstBuilder
    {
        public MethodBody_CAMPY_AstBuilder(DecompilerContext context)
            : base(context)
        { }
        ...
        public override void GenerateCode(ITextOutput output)
        {
            ...
            syntaxTree.AcceptVisitor(new MethodBody_CSharpOutputVisitor(outputFormatter, formattingPolicy));
        }
    }
    ...
    /// Outputs the AST.
    /// </summary>
    public class MethodBody_CSharpOutputVisitor : CSharpOutputVisitor
    {
        public MethodBody_CSharpOutputVisitor(IOutputFormatter formatter, CSharpFormattingOptions formattingPolicy)
