...
namespace TreeWalker
{
    ...
    public class CAMPY_AstBuilder
    {
        protected DecompilerContext context;
        protected SyntaxTree syntaxTree = new SyntaxTree();
        ...
        public CAMPY_AstBuilder(DecompilerContext context)
        {
            if (context == null)
        ...
        virtual public void GenerateCode(ITextOutput output)
        {
